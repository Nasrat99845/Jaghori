...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 NASRAT-TECH
\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨
...
class Main:
	...
	def fbtua(self):
		...
		try:
			...
			exit("\n\n \033[0;95m>>[PROCESS COMPLETE... \n\033[0;92m >>[Thanks For Using NASRAT-TECH Tools.")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [NASRAT TECH] %s | %s\033[1;32m         "%(uid, pw))
